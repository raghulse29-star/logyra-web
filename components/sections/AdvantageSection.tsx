...
const whatLogyraIs = [
  ...
  // },
  {
    ...
    desc: 'Trade Ideas Focused Strictly On Rigorous Process Execution.',
    icon: <CheckIcon />,
    colSpan: 1
  },
  {
