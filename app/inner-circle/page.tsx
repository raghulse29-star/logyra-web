...
const derivativesFeatures = [
  { title: 'Index Options Analysis', desc: 'Nifty & BankNifty options chain insights with IV analysis and key strike levels.' },
  { title: 'Stock Options Coverage', desc: 'High-conviction stock option setups with defined risk parameters and expiry strategies.' },
  { title: 'Options Chain Interpretation', desc: 'Max pain, PCR ratios, and open interest buildup decoded into actionable context.' },
  { title: 'Futures Market Structure', desc: 'Rollover data, futures premium analysis, and institutional positioning insights.' },
    ...
    <main className="font-sans">
      ...
      <section className="relative bg-[#18261b] pt-24 pb-12 sm:pt-28 sm:pb-16 md:pt-36 md:pb-24 overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            Institutional-grade F&amp;O educational insights and pre-market research briefs — built for serious market participants who want clarity, not noise.
          </motion.p>
          ...
          >
            {sectionNavItems.map((item) => (
              <button
                ...
                className="text-[12px] text-gray-300 border border-white/20 hover:border-[#6bc28b]/60 hover:text-[#6bc28b] px-3 py-1.5 rounded-sm transition-all duration-200 tracking-wide"
              >
                {item.label}
              </button>
            ))}
